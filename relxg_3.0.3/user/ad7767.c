...
void change_buff(void)
{
	if(addata_cnt >= BUFF_SIZE)
	{
			...
			if(p_ad_begin == AD7767_Ping)
			{
				    ...
				    process_buffer_and_sum1(AD7767_Ping,BUFF_SIZE);
					process_buffer_and_sum2(AD7767_Ping,BUFF_SIZE);
					process_buffer_and_sum3(AD7767_Ping,BUFF_SIZE);
					process_buffer_and_sum4(AD7767_Ping,BUFF_SIZE);
					//process_fre(AD7767_Ping, fre_ping, BUFF_SIZE);
			}	
...
//				    process_buffer_and_sum1(AD7767_Pang,BUFF_SIZE);
//					process_buffer_and_sum2(AD7767_Pang,BUFF_SIZE);
//					process_buffer_and_sum3(AD7767_Pang,BUFF_SIZE);
//				    process_buffer_and_sum4(AD7767_Pang,BUFF_SIZE);
					//process_fre(AD7767_Pang, fre_pang, BUFF_SIZE);
			}	
	}
}
