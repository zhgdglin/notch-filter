...
#define POWER_9V_Pin GPIO_PIN_6
#define POWER_9V_GPIO_Port GPIOC
#define LIMIT_1_Pin GPIO_PIN_0
#define LIMIT_1_GPIO_Port GPIOD
#define LIMIT_2_Pin GPIO_PIN_1
#define LIMIT_2_GPIO_Port GPIOD
#define POWER_MOTOR_Pin GPIO_PIN_3
#define POWER_MOTOR_GPIO_Port GPIOD
#define MOTOR_Pin GPIO_PIN_4
#define MOTOR_GPIO_Port GPIOD
#define SD_CRL_Pin GPIO_PIN_7
#define SD_CRL_GPIO_Port GPIOD
#define POWER_3V3_Pin GPIO_PIN_5
